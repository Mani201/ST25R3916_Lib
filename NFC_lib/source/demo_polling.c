...
static void demoNotif( rfalNfcState st )
{
    ...
    {
        myprintf(0,"Wake Up mode started \r\n");
    }
    else if( st == RFAL_NFC_STATE_POLL_TECHDETECT )
    {
        if( discParam.wakeupEnabled )
        {
            myprintf(0,"Wake Up mode terminated. Polling for devices \r\n");
        }
    }
    else if( st == RFAL_NFC_STATE_POLL_SELECT )
    {
        ...
        if( (!multiSel) )
        {
            ...
            myprintf(0,"Multiple Tags detected: %d \r\n", devCnt);
        }
        else
        {
...
void demoCycle( void )
{
    ...
    if( platformGpioIsLow(PLATFORM_USER_BUTTON_PORT, PLATFORM_USER_BUTTON_PIN))
    {
        ...
        myprintf(0,"Toggling Wake Up mode %s\r\n", discParam.wakeupEnabled ? "ON": "OFF");
            ...
            if( rfalNfcIsDevActivated( rfalNfcGetState() ) )
            {
                ...
                switch( nfcDevice->type )
                {
                    ...
                    case RFAL_NFC_LISTEN_TYPE_NFCA:
                        ...
                        {
                            case RFAL_NFCA_T1T:
                                myprintf(0,"ISO14443A/Topaz (NFC-A T1T) TAG found. UID: %s\r\n", hex2Str( nfcDevice->nfcid, nfcDevice->nfcidLen ) );
                                break;

                            case RFAL_NFCA_T4T:
                                myprintf(0,"NFCA Passive ISO-DEP device found. UID: %s\r\n", hex2Str( nfcDevice->nfcid, nfcDevice->nfcidLen ) );
                            ...
                            case RFAL_NFCA_NFCDEP:
                                myprintf(0,"NFCA Passive P2P device found. NFCID: %s\r\n", hex2Str( nfcDevice->nfcid, nfcDevice->nfcidLen ) );

                                demoP2P( nfcDevice );
                                break;

                            default:
                                myprintf(0,"ISO14443A/NFC-A card found. UID: %s\r\n", hex2Str( nfcDevice->nfcid, nfcDevice->nfcidLen ) );
                    ...
                    case RFAL_NFC_LISTEN_TYPE_NFCB:
                        ...
                        myprintf(0,"ISO14443B/NFC-B card found. UID: %s\r\n", hex2Str( nfcDevice->nfcid, nfcDevice->nfcidLen ) );
                    ...
                    case RFAL_NFC_LISTEN_TYPE_NFCF:
                        ...
                        {
                            myprintf(0,"NFCF Passive P2P device found. NFCID: %s\r\n", hex2Str( nfcDevice->nfcid, nfcDevice->nfcidLen ) );
                            demoP2P( nfcDevice );
                        }
                        else
                        {
                            myprintf(0,"Felica/NFC-F card found. UID: %s\r\n", hex2Str( nfcDevice->nfcid, nfcDevice->nfcidLen ));
                    ...
                    case RFAL_NFC_LISTEN_TYPE_NFCV:
                        {
                            ...
                            myprintf(5,"ISO15693/NFC-V card found. UID: %s\r\n", hex2Str(devUID, RFAL_NFCV_UID_LEN));
                    ...
                    case RFAL_NFC_LISTEN_TYPE_ST25TB:
                        ...
                        myprintf(0,"ST25TB card found. UID: %s\r\n", hex2Str( nfcDevice->nfcid, nfcDevice->nfcidLen ));
                        platformLedOn(PLATFORM_LED_B_PORT, PLATFORM_LED_B_PIN);
                        break;
                    ...
                    case RFAL_NFC_POLL_TYPE_AP2P:
                        ...
                        myprintf(0,"NFC Active P2P device found. NFCID3: %s\r\n", hex2Str(nfcDevice->nfcid, nfcDevice->nfcidLen));
...
void demoP2P( rfalNfcDevice *nfcDev )
{
    ...
    myprintf(0,"succeeded.\r\n");

    myprintf(0," Push NDEF Uri: www.st.com/st25-demo ... ");
    ...
    myprintf(0," Device present, maintaining connection ");
